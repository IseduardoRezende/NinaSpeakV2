...
namespace NinaSpeakV2.Domain.Services.IServices
{
    ...
    {
        Task<IEnumerable<TReadViewModel>> GetAsync(bool ignoreGlobalFilter = false, params string[] includes);
        ...
        Task<TReadViewModel?> GetByAsync(Func<TEntity, bool> filter, bool ignoreGlobalFilter = false, params string[] includes);
    }
}
